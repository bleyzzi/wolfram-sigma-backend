from wolfram_sigma_backend.app.web_api.chat import chat_router
...
routers = [main_page_router, test_router, user_account_page, equations_router, chat_router, verify_router]
